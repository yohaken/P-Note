import { loadNotes, saveNotes, peekLocalNotesVersion, exportNotesBlob, isCloudPending, markCloudPending } from './local.js?v=224';
import { attachNoteCardInteractions, positionContextMenu, clearUiTextSelection } from './context-menu.js?v=224';
import { initListSortable, initGridSortable } from './sortable.js?v=224';
import { CONFIG } from './config.js?v=224';
import { hasAnyNotes, hasCloudContent, tryAutoImport, importFromText, mergeNotesByUpdatedAt, localNeedsRemotePush } from './import-data.js?v=224';
import { nowIso } from './clock.js?v=224';
import {
  getAllowedUser,
  handleAuthRedirect,
  startLogin,
...
import {
  ...
  handleTextareaTab,
  normalizeTextPrefs,
} from './note-text.js?v=224';
import { bindComposableInput } from './text-input.js?v=224';
import {
...
import { densityToCssUnit, loadSettings, normalizeNotifyPrefs, normalizeGeminiModel, normalizeFilterOrder, normalizeAiProfile, normalizeAiTagRules, normalizeCameraQuality, normalizeCameraFacing, normalizeCameraSaveToDevice, normalizePriorityColors, normalizeDueColors, normalizeCalorieTones, normalizeCalorieTrendDays, calorieToneCssVars, normalizeCardDisplay, DEFAULT_CARD_DISPLAY, DEFAULT_PRIORITY_COLORS, DEFAULT_DUE_COLORS, DEFAULT_CALORIE_TONES, FIXED_UI, saveSettings, settingsForCloud, mergeSettingsFromCloud, thicknessStyleVars, dockScaleToCss, dockOffsetYToLiftPx, touchRecentNotepadId } from './settings.js?v=224';
import {
  allIcons,
  bestIconForLabel,
...
function loadGeminiMod() {
  if (!geminiModPromise) geminiModPromise = import('./gemini.js?v=224');
  return geminiModPromise;
}
function loadCameraMod() {
  if (!cameraModPromise) cameraModPromise = import('./camera.js?v=224');
  return cameraModPromise;
}
function loadUserContextMod() {
  if (!userContextModPromise) userContextModPromise = import('./user-context.js?v=224');
...
import { DEFAULT_BAR_LAYOUT } from './bars.js?v=224';
import {
  fetchRemoteNotes,
  getSpaceId,
  getPreviousSpaceId,
  ...
  watchRemoteNotes,
  SHARED_SPACE_ID,
} from './remote.js?v=224';
import { normalizeNotesData } from './notes.js?v=224';
import { SaveManager } from './sync.js?v=224';
import { emptyDeletions } from './deletions.js?v=224';
import { NOTE_APP_VERSION, getAppBuild, formatAppBuildLabel, formatAppBuiltAt } from './version.js?v=224';
